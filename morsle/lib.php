...
/**
 * List of features supported in morsle module
 * @param string $feature FEATURE_xx constant for requested feature
 * @return mixed True if module supports feature, false if not, null if doesn't know
 */
function morsle_supports($feature) {
    switch($feature) {
 ...
 * @return array
 */
function morsle_get_extra_capabilities() {
 ...
 */
function morsle_reset_userdata($data) {
    return array();
}
 ...
 * @return array
 */
function morsle_get_view_actions() {
 ...
 * @return array
 */
function morsle_get_post_actions() {
 ...
 * @return bool true
 */
function morsle_update_instance($data, $mform) {
    global $CFG, $DB;
 ...
 * @return bool true
 */
function morsle_delete_instance($id) {
    global $DB;

    if (!$morsle = $DB->get_record('morsle', array('id'=>$id))) {
        return false;
    }

    // note: all context files are deleted automatically

    $DB->delete_records('morsle', array('id'=>$morsle->id));
 ...
 * @return object|null
 */
function morsle_user_outline($course, $user, $mod, $url) {
    global $DB;
 ...
 * @param object $url
 */
function morsle_user_complete($course, $user, $mod, $url) {
    global $CFG, $DB;
...
function morsle_get_coursemodule_info($coursemodule) {
    ...
    if (!$url = $DB->get_record('morsle', array('id'=>$coursemodule->instance),
 ...
 */
function morsle_page_type_list($pagetype, $parentcontext, $currentcontext) {
 ...
 */
function mod_morsle_dndupload_register() {
 ...
 */
function mod_morsle_dndupload_handle($uploadinfo) {
    ...
    return morsle_add_instance($data, null);
}
